 package com.today36524.api.user.response.serializer;
        ...
        **/
        ...
        class BlackUserSqlResponseSerializer extends TCommonBeanSerializer[com.today36524.api.user.response.BlackUserSqlResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.response.BlackUserSqlResponse = {
      ...
      val bean = com.today36524.api.user.response.BlackUserSqlResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.response.BlackUserSqlResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("BlackUserSqlResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.response.BlackUserSqlResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.response.BlackUserSqlResponse): String = if (bean == null) "null" else bean.toString
