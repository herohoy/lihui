 package com.today36524.api.user.response.serializer;
        ...
        **/
        ...
        class LoginUserSqlResponseSerializer extends TCommonBeanSerializer[com.today36524.api.user.response.LoginUserSqlResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.response.LoginUserSqlResponse = {
      ...
      val bean = com.today36524.api.user.response.LoginUserSqlResponse(userName = userName,telephone = telephone,status = status,email = email,qq = qq,integral = integral,createdAt = createdAt,updatedAt = updatedAt)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.response.LoginUserSqlResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("LoginUserSqlResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.response.LoginUserSqlResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.response.LoginUserSqlResponse): String = if (bean == null) "null" else bean.toString
