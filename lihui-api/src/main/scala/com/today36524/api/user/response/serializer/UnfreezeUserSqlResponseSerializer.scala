 package com.today36524.api.user.response.serializer;
        ...
        **/
        ...
        class UnfreezeUserSqlResponseSerializer extends TCommonBeanSerializer[com.today36524.api.user.response.UnfreezeUserSqlResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.response.UnfreezeUserSqlResponse = {
      ...
      val bean = com.today36524.api.user.response.UnfreezeUserSqlResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.response.UnfreezeUserSqlResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("UnfreezeUserSqlResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.response.UnfreezeUserSqlResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.response.UnfreezeUserSqlResponse): String = if (bean == null) "null" else bean.toString
