    ...
    ####  输出
        1.user_response.RegisterUserResponse
            ...
            **/
            ...
            def registerUser(
            request: com.today36524.api.user.request.RegisterUserRequest ): com.today36524.api.user.response.RegisterUserResponse
    ...
    ####  输出
        1.user_response.LoginUserResponse
            ...
            **/
            ...
            def login(
            request: com.today36524.api.user.request.LoginUserRequest ): com.today36524.api.user.response.LoginUserResponse
    ...
    ####  输出
        1.user_response.ModifyUserAction
            ...
            **/
            ...
            def modifyUser(
            request: com.today36524.api.user.request.ModifyUserRequest ): com.today36524.api.user.response.ModifyUserResponse
    ...
    ####  输出
        1.user_response.FreezeUserResponse
            ...
            **/
            ...
            def freezeUser(
            request: com.today36524.api.user.request.FreezeUserRequest ): com.today36524.api.user.response.FreezeUserResponse
    ...
    ####  输出
        1.user_response.BlackUserResponse
            ...
            **/
            ...
            def blackUser(
            request: com.today36524.api.user.request.BlackUserRequest ): com.today36524.api.user.response.BlackUserResponse
    ...
    ####  输出
        1. i32 流水 Id
            ...
            **/
            ...
            request: com.today36524.api.user.request.ChangeIntegralRequest ): Int
    ...
    ####  输出
        1.user_response.UnfreezeUserResponse
            ...
            **/
            ...
            def unfreezeUser(
            request: com.today36524.api.user.request.UnfreezeUserRequest ): com.today36524.api.user.response.UnfreezeUserResponse
    ...
    ####  输出
        1.user_response.RegisterUserResponse
            ...
            **/
            ...
            def registerUserSql(
            request: com.today36524.api.user.request.RegisterUserRequest ): com.today36524.api.user.response.RegisterUserSqlResponse
    ...
    ####  输出
        1.user_response.LoginUserResponse
            ...
            **/
            ...
            def loginSql(
            request: com.today36524.api.user.request.LoginUserRequest ): com.today36524.api.user.response.LoginUserSqlResponse
    ...
    ####  输出
        1.user_response.ModifyUserAction
            ...
            **/
            ...
            def modifyUserSql(
            request: com.today36524.api.user.request.ModifyUserRequest ): com.today36524.api.user.response.ModifyUserSqlResponse
    ...
    ####  输出
        1.user_response.FreezeUserResponse
            ...
            **/
            ...
            def freezeUserSql(
            request: com.today36524.api.user.request.FreezeUserRequest ): com.today36524.api.user.response.FreezeUserSqlResponse
    ...
    ####  输出
        1.user_response.BlackUserResponse
            ...
            **/
            ...
            def blackUserSql(
            request: com.today36524.api.user.request.BlackUserRequest ): com.today36524.api.user.response.BlackUserSqlResponse
    ...
    ####  输出
        1.user_response.UnfreezeUserResponse
            ...
            **/
            ...
            def unfreezeUserSql(
            request: com.today36524.api.user.request.UnfreezeUserRequest ): com.today36524.api.user.response.UnfreezeUserSqlResponse
