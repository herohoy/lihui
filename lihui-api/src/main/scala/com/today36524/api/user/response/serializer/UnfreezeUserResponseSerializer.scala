 package com.today36524.api.user.response.serializer;
        ...
        **/
        ...
        class UnfreezeUserResponseSerializer extends TCommonBeanSerializer[com.today36524.api.user.response.UnfreezeUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.response.UnfreezeUserResponse = {
      ...
      val bean = com.today36524.api.user.response.UnfreezeUserResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.response.UnfreezeUserResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("UnfreezeUserResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.response.UnfreezeUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.response.UnfreezeUserResponse): String = if (bean == null) "null" else bean.toString
