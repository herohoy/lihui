 package com.today36524.api.user.request.serializer;
        ...
        **/
        ...
        class UnfreezeUserRequestSerializer extends TCommonBeanSerializer[com.today36524.api.user.request.UnfreezeUserRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.request.UnfreezeUserRequest = {
      ...
      val bean = com.today36524.api.user.request.UnfreezeUserRequest(userId = userId,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.request.UnfreezeUserRequest, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("UnfreezeUserRequest"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.request.UnfreezeUserRequest): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.request.UnfreezeUserRequest): String = if (bean == null) "null" else bean.toString
