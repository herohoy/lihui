 package com.today36524.api.user.response.serializer;
        ...
        **/
        ...
        class ModifyUserResponseSerializer extends TCommonBeanSerializer[com.today36524.api.user.response.ModifyUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.response.ModifyUserResponse = {
      ...
      val bean = com.today36524.api.user.response.ModifyUserResponse(userName = userName,telephone = telephone,status = status,email = email,qq = qq,updatedAt = updatedAt)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.response.ModifyUserResponse, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.response.ModifyUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.response.ModifyUserResponse): String = if (bean == null) "null" else bean.toString
