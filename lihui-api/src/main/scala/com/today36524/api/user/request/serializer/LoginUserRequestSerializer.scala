 package com.today36524.api.user.request.serializer;
        ...
        **/
        ...
        class LoginUserRequestSerializer extends TCommonBeanSerializer[com.today36524.api.user.request.LoginUserRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.request.LoginUserRequest = {
      ...
      val bean = com.today36524.api.user.request.LoginUserRequest(passWord = passWord,telephone = telephone)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.request.LoginUserRequest, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.request.LoginUserRequest): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.request.LoginUserRequest): String = if (bean == null) "null" else bean.toString
